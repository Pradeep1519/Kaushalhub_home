...
export function StudentPortalNav({
  ...
  const navigationItems = [
    {
      ...
      label: "Dashboard",
      icon: Home,
      badge: null, // No notification badge for dashboard
    },
    {
      id: "my-courses",
      label: "My Courses",
      icon: BookOpen,
      badge: user?.enrolledCourses?.length || 0, // Show enrolled courses count
    },
    {
      id: "course-player",
    ...
    },
    {
      ...
      label: "Live Classes",
      icon: Calendar,
      badge: 2, // Mock notification for upcoming classes
    },
    {
      id: "assignments",
      label: "Assignments",
      icon: FileText,
      badge: 3, // Mock notification for pending assignments
    },
    {
      id: "certificates",
      label: "Certificates",
    ...
    },
    {
      ...
      label: "Community",
      icon: Users,
      badge: 5, // Mock notification for new messages
    },
    {
      id: "profile",
      label: "Profile",
  ...
  return (
    <>
      {/* Mobile Menu Button */}
      <motion.button
        className={`${styles.mobileMenuButton} fixed top-4 left-4 z-50 lg:hidden bg-white dark:bg-gray-900 p-2 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700`}
      ...
      {/* Sidebar Navigation */}
      <motion.aside
        className={`${styles.sidebar} fixed top-0 left-0 h-full bg-white dark:bg-gray-900 border-r border-gray-200 dark:border-gray-700 z-40`}
        initial={{ x: -280 }}
        animate={{ 
          x: isMobileMenuOpen ? 0 : -280, // Mobile: slide in/out
        }}
        transition={{
          type: "spring",
          stiffness: 300,
