...
export function PrivacyPolicy({ onBack }: PrivacyPolicyProps) {
  const lastUpdated = "Septamber, 2025";
    ...
    >
      <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
              {[
                ...
                <a
                  key={item.section}
                  href={`#${item.section}`}
                  className="text-blue-600 hover:text-blue-800 hover:underline text-center py-2 px-3 rounded-lg bg-blue-50 hover:bg-blue-100 transition-colors"
                >
                  {item.label}
                </a>
              ))}
        ...
        <div className="grid lg:grid-cols-4 gap-8">
              ...
              <nav className="space-y-2">
                {[
                  ...
                  <a
                    key={item.id}
                    href={`#${item.id}`}
                    className="block text-sm text-gray-600 hover:text-blue-600 hover:underline py-1 transition-colors"
                  >
                    {item.title}
                  </a>
                ))}
          ...
          >
            {/* Introduction */}
            <section id="introduction" className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 scroll-mt-8">
            ...
            <section id="information-collection" className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 scroll-mt-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 pb-4 border-b border-gray-200 flex items-center gap-3">
            ...
            {/* Data Usage */}
            <section id="data-usage" className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 scroll-mt-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 pb-4 border-b border-gray-200 flex items-center gap-3">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">Primary Purposes</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">Secondary Purposes</h3>
                  <ul className="space-y-3 text-gray-700">
                    {[
            ...
            {/* Data Sharing */}
            <section id="data-sharing" className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 scroll-mt-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 pb-4 border-b border-gray-200">
                4. Information Sharing & Disclosure
              </h2>
              
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-6">
                <h4 className="font-semibold text-yellow-800 mb-2">Our Commitment</h4>
            ...
            {/* Data Security */}
            <section id="data-security" className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 scroll-mt-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 pb-4 border-b border-gray-200 flex items-center gap-3">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">Organizational Measures</h3>
                  <ul className="space-y-3 text-gray-700">
                    {[
            ...
            {/* Your Rights */}
            <section id="your-rights" className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 scroll-mt-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 pb-4 border-b border-gray-200">
            ...
            {/* Contact Information */}
            <section id="contact" className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 scroll-mt-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 pb-4 border-b border-gray-200">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-lg font-semibold text-gray-800 mb-4">Privacy Team</h3>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    <a href="#" className="block text-blue-600 hover:underline py-1">Data Access Request Form</a>
                    <a href="#" className="block text-blue-600 hover:underline py-1">Consent Management Portal</a>
                    <a href="#" className="block text-blue-600 hover:underline py-1">Cookie Preferences</a>
                    <a href="#" className="block text-blue-600 hover:underline py-1">FAQ - Privacy Questions</a>
                  </div>
                </div>
              </div>
            </section>
            ...
            {/* Grievance Officer */}
            <section id="grievance" className="bg-white rounded-xl shadow-sm border border-gray-200 p-8 scroll-mt-8">
              <h2 className="text-2xl font-bold text-gray-900 mb-6 pb-4 border-b border-gray-200">
